...
public abstract class Player {
  ...
  public Player(Synthesizer synthesizer, Instrument instrument, int channel) {
  ...
  protected void play(ActiveSound activeSound) {
  ...
  protected void releaseExpiredSounds(long tick) {
